...
procedure $new(obj_type:javaType) returns ($obj:ref);    requires $heap[$obj,$alloc] == false;        ensures $heap[$obj,$alloc] == true;    ensures $heap[$obj,$type] == obj_type;    ensures $obj != $null;
