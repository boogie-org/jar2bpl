...
public class RelativeImageView extends View implements ImageObserver, MouseListener, MouseMotionListener
{
	 ...
	 * @return boolean - returns whether it is an URL or not
	 */
	 ...
	 * @return String -  appends the relative path to the absolute path and returns the String. 
	 */
	...
	/** Fetches the attributes to use when rendering. This is
	  ...
	  * @return AttributeSet - returns a set of attributes
	  */
	 ...
	 * @return boolean - wheather it is a link or not
	 */
	boolean isLink()
	{
	 ...
	 * @return int - size of extra space to be added along the axis
	 */
	 ...
	 * @return float - vertical alignment
	 */
	...
	/**
	 * @param obs - image
	 * @return boolean - returns wheather image has pixels or not
	 */
	 ...
	 * @return URL - returns image source
	 */
	 ...
	 * @param iDefault - idefault value of attribute
	 * @return int - returns integer-valued attribute
	 */
	...
	*/
	...
	/**
	 * @return boolean - wheather it is editable or not
	 */
	...
	/**
	 * @param gifFile - name of gif file
	 * @return Icon - icon of gif file
	 * @throws IOException - gif file not found
	 */
	...
	/**
	 * @return StyleSheet - stylesheet of html document
	 */
